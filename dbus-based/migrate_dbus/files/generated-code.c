...
static void
_g_dbus_codegen_marshal_BOOLEAN__OBJECT_BOOLEAN_BOOLEAN (
    GClosure     *closure,
    GValue       *return_value,
    ...
    void         *marshal_data)
{
  typedef gboolean (*_GDbusCodegenMarshalBoolean_ObjectBooleanBooleanFunc)
       (void *data1,
        GDBusMethodInvocation *arg_method_invocation,
        gboolean arg_make_sad,
        gboolean arg_make_happy,
        void *data2);
  _GDbusCodegenMarshalBoolean_ObjectBooleanBooleanFunc callback;
  ...
  callback = (_GDbusCodegenMarshalBoolean_ObjectBooleanBooleanFunc)
...
enum
{
  EXAMPLE__ANIMAL_JUMPED,
};

static unsigned EXAMPLE__ANIMAL_SIGNALS[1] = { 0 };
...
inline static void
example_animal_signal_marshal_jumped (
    GClosure     *closure,
    GValue       *return_value,
    unsigned int  n_param_values,
    const GValue *param_values,
...
inline static void
example_animal_method_marshal_poke (
    GClosure     *closure,
    GValue       *return_value,
    unsigned int  n_param_values,
    const GValue *param_values,
    ...
    void         *marshal_data)
{
  _g_dbus_codegen_marshal_BOOLEAN__OBJECT_BOOLEAN_BOOLEAN (closure,
    return_value, n_param_values, param_values, invocation_hint, marshal_data);
}
...
example_animal_default_init (ExampleAnimalIface *iface)
{
   ...
   * Since: 2.30
   */
  EXAMPLE__ANIMAL_SIGNALS[EXAMPLE__ANIMAL_JUMPED] =
    g_signal_new ("jumped",
      G_TYPE_FROM_INTERFACE (iface),
      G_SIGNAL_RUN_LAST,
...
{
  g_return_val_if_fail (EXAMPLE_IS_ANIMAL (object), NULL);
...
example_animal_emit_jumped (
    ...
    gdouble arg_height)
{
  g_signal_emit (object, EXAMPLE__ANIMAL_SIGNALS[EXAMPLE__ANIMAL_JUMPED], 0, arg_height);
}
...
void
example_animal_complete_poke (
    ExampleAnimal *object G_GNUC_UNUSED,
 ...
 */
guint
example_cat_override_properties (GObjectClass *klass G_GNUC_UNUSED, guint property_id_begin)
{
  return property_id_begin - 1;
}
...
static void
example_cat_default_init (ExampleCatIface *iface G_GNUC_UNUSED)
{
}
...
static void
example_cat_proxy_get_property (GObject      *object G_GNUC_UNUSED,
...
static void
example_cat_proxy_set_property (GObject      *object G_GNUC_UNUSED,
  guint         prop_id G_GNUC_UNUSED,
...
static void
example_cat_proxy_iface_init (ExampleCatIface *iface G_GNUC_UNUSED)
{
}
...
static void
example_cat_skeleton_dbus_interface_flush (GDBusInterfaceSkeleton *_skeleton G_GNUC_UNUSED)
{
}
...
static void
example_cat_skeleton_iface_init (ExampleCatIface *iface G_GNUC_UNUSED)
{
}
  ...
  if (g_once_init_enter (&once_init_value))
    {
      ...
      g_hash_table_insert (lookup_hash, (gpointer) "org.gtk.GDBus.Example.ObjectManager.Animal", (gpointer) (guintptr) (EXAMPLE_TYPE_ANIMAL_PROXY));
      g_hash_table_insert (lookup_hash, (gpointer) "org.gtk.GDBus.Example.ObjectManager.Cat", (gpointer) (guintptr) (EXAMPLE_TYPE_CAT_PROXY));
